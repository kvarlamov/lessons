...
namespace RecursionTests
{
    ...
    public class FindSecondMaxTests
    {
        ...
        private static IEnumerable<TestCaseData> GetData()
        {
            ...
            yield return new TestCaseData(new List<int>() {5,4, 4, 3}, 4);
            yield return new TestCaseData(new List<int>() {5,4, 4, 6}, 5);
            yield return new TestCaseData(new List<int>() {5,4, 6, 6}, 6);
        }
    }
}