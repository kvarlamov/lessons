...
namespace RecursionTests
{
    ...
    public class FindSecondMaxTests
    {
        ...
        {
            yield return new TestCaseData(new List<int>(){ 5,4,3,2,5 }, 4);
            ...
            yield return new TestCaseData(new List<int>(){ 2,4,2,3, 6, 1, 2,6, 5 }, 7);
            yield return new TestCaseData(new List<int>() {0, 0, 0, 0, 0, 0}, 1);
        }
    }
}